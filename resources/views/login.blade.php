    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div class="hidden md:flex md:w-1/2 flex-col justify-center items-center p-8 lg:p-12 bg-blue-600 dark:bg-blue-700 text-white">
            <div class="text-center max-w-xl">
                ...
                <p class="text-base lg:text-lg font-light leading-relaxed mb-6 opacity-90">
                    Welcome to our online application system. Edotech empowers future innovators through hands-on technical education.
                </p>
                <div class="mt-8 space-y-4">
                    ...
                    <a href="#"
                       class="block text-white text-sm opacity-80 hover:opacity-100 transition-all">
                       <span class="mr-2">&rarr;</span> How to Complete Your Application
                    </a>
                </div>
            </div>
        </div>

        {{-- Right Column: Login Form (Full Width on Mobile, Half on Desktop) --}}
        <div class="w-full h-screen md:w-1/2 flex flex-col justify-center p-8 sm:p-12 bg-gray-50 dark:bg-gray-800">
            <div class="max-w-sm w-full mx-auto p-6 md:p-0">
                ...
                <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white mb-8 text-center">Already Registered? Log In</h2>
                <form action="{{ route('auth.login') }}" method="POST" class="space-y-6">
                    ...
                    <a href="#" class="block text-center text-sm text-gray-600 dark:text-gray-400 hover:underline mt-4">Forgot Password?</a>
                    <div class="mt-6 text-center">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            Don't have an account? <a href="{{ route('auth.register') }}" class="font-bold underline text-blue-600 hover:text-blue-700">Register</a>
                        </p>
                    </div>
                </form>
            </div>
